...
if (isset($_GET['delete_id'])) {
    ...
    header("Location: delete_publisher.php");
    exit;
}
...
<head>
  ...
  <title>AdminLTE 3 | Delete Publishers</title>
  <!-- Styles links -->
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Delete Publishers</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                <li class="breadcrumb-item"><a href="publishers_list.php">Publishers</a></li>
                <li class="breadcrumb-item active">Delete Publishers</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Publishers List</h3>
                        ...
                        <?php foreach ($publishers as $pub): ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="delete_publisher.php?delete_id=<?= $pub['id'] ?>"
