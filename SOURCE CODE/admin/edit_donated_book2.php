...
<head>
  ...
  <title>AdminLTE 3 | Edit Donated Books</title>
  <!-- styles links -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Donated Books</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Edit Donated Books</h3>
              ...
              <div class="col-md-8">
                <form method="GET" class="form-inline">
                  ...
                  <?php if (!empty($search) || !empty($status_filter)): ?>
                    <a href="edit_donated_book2.php" class="btn btn-default">Clear Filters</a>
                  <?php endif; ?>
                </form>
              </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <a href="delete_donated_book.php?delete_id=<?= $book['id'] ?>" 
