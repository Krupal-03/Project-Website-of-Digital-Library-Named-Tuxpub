...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['approve_id'])) {
        ...
        if ($book) {
            ...
            header("Location: donated_books_list.php?success=1");
            exit;
        }
    }
    ...
    if (isset($_POST['delete_id'])) {
        ...
        header("Location: donated_books_list.php?success=2");
        exit;
    }
}
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">All Donated Books</h3>
                    <div class="card-tools">
                        <a href="donated_books_approval.php" class="btn btn-primary btn-sm">
                            <i class="fas fa-tasks"></i> Approval Panel
                        </a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-8">
                            <form method="GET" class="form-inline">
                                ...
                                <?php if (!empty($search) || !empty($status_filter)): ?>
                                    <a href="donated_books_list.php" class="btn btn-default">Clear Filters</a>
                                <?php endif; ?>
                            </form>
                        </div>
