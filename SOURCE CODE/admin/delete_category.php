...
if (isset($_GET['id'])) {
    ...
    // Optional: unlink category icon file if needed
    $stmt = $pdo->prepare("SELECT icon FROM categories WHERE id = ?");
    $stmt->execute([$id]);
    $cat = $stmt->fetch(PDO::FETCH_ASSOC);
    if ($cat && file_exists($cat['icon'])) {
        unlink($cat['icon']); // delete the icon file
    }
...
// Fetch all categories with search
...
<head>
  ...
  <title>AdminLTE 3 | Delete Categories</title>
  <!-- styles links -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Delete Categories</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item"><a href="categories_list.php">Categories</a></li>
              <li class="breadcrumb-item active">Delete Categories</li>
            </ol>
          </div>
        </div>
      </div>
