...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      $stmt = $pdo->prepare("SELECT id, thumbnail, title, author, publish_date, file_path FROM books $where ORDER BY id DESC");
      $stmt->execute($params);
                    ...
                    <tbody>
                      <?php foreach ($books as $book): ?>
                        <tr>
                          ...
                          <td>
                            <form action="delete_bookB.php" method="POST" style="display:inline;"
